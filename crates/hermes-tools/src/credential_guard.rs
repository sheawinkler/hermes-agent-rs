...
mod tests {
    ...
    fn test_check_write_access_blocked_content() {
        ...
        assert!(guard.check_write_access(Path::new("config.txt"), "sk-abcdefghijklmnopqrstuvwxyz1234567890").is_err());
    ...
    fn test_path_only_guard() {
        ...
        assert!(guard.check_write_access(Path::new("output.txt"), "sk-abcdefghijklmnopqrstuvwxyz1234567890").is_ok());
    }
